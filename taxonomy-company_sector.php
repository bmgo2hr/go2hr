...
<?php
    ...
    $tax_array[1]['taxonomy'] = 'company_sector';
    $tax_array[1]['terms'] = $term_slug;
    $tax_array[1]['field'] = 'slug';

    $region_array = array();
    if (isset($_GET['comp_region']) && !empty($_GET['comp_region'])) {
        $region = $_GET['comp_region'];
        $region_array = explode(',', $region);
        $tax_array[2]['relation'] = 'OR';
        $tax_array[2][1]['taxonomy'] = 'company_region';
        $tax_array[2][1]['field'] = 'term_id';
        $tax_array[2][1]['terms'] = $region_array;
        $tax_array[2][1]['operator'] = 'IN';
    }
...
function formUrl() {
    ...
    window.location.href = '<?php echo home_url(); ?>/company_sector/<?php echo $term_slug; ?>' + url;
}
...
jQuery('.D-radius a').each(function() {
     ...
     if (jQuery(this).hasClass('prev')) {
        ...
        jQuery(this).attr('href', '<?php echo $page_url; ?>'+'/<?php echo $term_slug; ?>'+'/page/'+prev_page_no+'/?<?php echo $queryString; ?>');
     } else if(jQuery(this).hasClass('next')) {
        const next_page_no = parseInt(current_page_no)+1;
        jQuery(this).attr('href', '<?php echo $page_url; ?>'+'/<?php echo $term_slug; ?>'+'/page/'+next_page_no+'/?<?php echo $queryString; ?>');
     } else {
        jQuery(this).attr('href', '<?php echo $page_url; ?>'+'/<?php echo $term_slug; ?>'+'/page/'+page_no+'/?<?php echo $queryString; ?>');
     }
})
