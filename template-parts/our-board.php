               ...
               <div class="row">
                  <div class="col-lg-8 col-12 mx-auto">
                     ...
                     <div class="row align-items-center justify-content-center">
                       <?php 
						$team = new WP_Query(array('post_type' => 'board','post_status' =>'publish','posts_per_page' => -1,'orderby' => 'date','order' => 'DESC')); // getting all training resources
						if ( $team -> have_posts() ) {
							$flg = 0;
...
<!-- Modal -->
<?php 
	$teams = new WP_Query(array('post_type' => 'board','post_status' =>'publish','posts_per_page' => -1,'orderby' => 'date','order' => 'DESC')); // getting all training resources
	if ( $teams -> have_posts() ) {
		$flag = 0;
