...
?>
 <main class="inr-page Training-page" id="Training">
		...
		<!-- grid -->
	<?php 
		$args = array('post_type'=>'go2hr_resources','paged'=>$paged,'posts_per_page'=> 10,'post_status'=>'publish',
		           'tax_query'=>array(array('taxonomy'=>'resource_tag','field'=> 'term_id','terms'=> $query_object->term_id,
					...
					<div class="col-12">
						<div class="ExploreAll-main">
							...
							if($mhr->have_posts()){
							   ...
							   <?php if(!empty($mhrTitle)){ ?><a href="<?php echo get_the_permalink(); ?>"><h4><?=$mhrTitle;?></h4></a><?php } ?>
