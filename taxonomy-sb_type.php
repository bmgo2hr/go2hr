...
?>
 ...
 <main class="inr-page Training-page" id="Training">
		...
		<!-- grid -->
		<?php 
		$args = array('post_type'=>'sb-resources','paged'=>$paged,'posts_per_page'=> 3,'post_status'=>'publish',
		           'tax_query'=>array(array('taxonomy'=>'sb_type','field'=> 'term_id','terms'=> $query_object->term_id,
				   'operator'  => 'IN') ),'orderby'=>'publish_date','order'=>'DESC');			 
		
        $sb = new WP_Query($args);
