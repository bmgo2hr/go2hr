<?php
	 ...
	 */
	namespace Go2HR\Helpers\UserProfile;

	/**
	 * Register AJAX handling actions for user login form
	 */
	add_action( 'wp_ajax_nopriv_g2hruserprofileupdate', array(new \G2hr_User_Profile(), 'update') );
	add_action( 'wp_ajax_g2hruserprofileupdate', array(new \G2hr_User_Profile(), 'update') );
