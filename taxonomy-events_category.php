...
?>
 <main class="inr-page Training-page" id="Training">
		...
		<!-- grid -->
	<?php 
		$args = array('post_type'=>'go2hr_events','paged'=>$paged,'posts_per_page'=> 10,'post_status'=>'publish',
		           'tax_query'=>array(array('taxonomy'=>'events_category','field'=> 'term_id','terms'=> $query_object->term_id,
