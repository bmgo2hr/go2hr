...
?>
 <main class="inr-page Training-page" id="Training">
		...
		<!-- grid -->
	<?php 
		$args = array('post_type'=>'go2hr_news','paged'=>$paged,'posts_per_page'=> 10,'post_status'=>'publish',
		           'tax_query'=>array(array('taxonomy'=>'news_region','field'=> 'term_id','terms'=> $query_object->term_id,
